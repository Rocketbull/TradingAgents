...
- Do not keep guessing Python interpreters after `.conda/tradingagents/bin/` is missing. Use the validated repo fallback `/home/rockebull/mambaforge/bin/python` and keep using it for the task.
