# MyTT indicators adapted for local parquet-backed TradingAgents workflows.
...
def _resolve_local_symbol(symbol: str, root_dir: str | None = None) -> str:
    ...
    try:
        from tradingagents.dataflows.ashare import normalize_symbol as normalize_ashare_symbol
